...
- Standards = `CLAUDE.md` + `docs/examples/` (older projects: `_docs/`) (read its `README.md`, then only the closest block's file). If those aren't in the project,
